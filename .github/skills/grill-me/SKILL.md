...
description: Identify languages and frameworks in the current project, load matching security guidance from the skill's references directory, and operate in three modes: write secure-by-default new code, passively flag critical vulnerabilities while working, or produce a prioritised security report with offered fixes. Covers OWASP Top 10, language-specific hardening, and framework-specific secure defaults.
---
